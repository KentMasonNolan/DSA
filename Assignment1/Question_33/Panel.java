...
public class Panel extends JPanel implements KeyListener, ShipPositionCallback{
    ...
    public Panel()
    {
        ...
        for(int i = 0; i < number_ship; i++)
        {
            ...
            ship_image = new ImageIcon(getClass().getResource("/Assignment1/Question_33/images/boat.png")).getImage();
            island_image = new ImageIcon(getClass().getResource("/Assignment1/Question_33/images/land.png")).getImage();
            boat_island_image = new ImageIcon(getClass().getResource("/Assignment1/Question_33/images/boat_land.png")).getImage();
